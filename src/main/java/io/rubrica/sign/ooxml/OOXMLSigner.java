...
public class OOXMLSigner implements Signer {
    ...
    public OOXMLSigner() {
        ...
        @Override
    public byte[] sign(byte[] data, String algorithm, PrivateKey key, Certificate[] certChain, Properties extraParams, ParametrosEntradaFirmas p_parametros) throws RubricaException, IOException {
      return this.sign(data, algorithm, key, certChain, extraParams);
    }
     ...
     * documento OOXML susceptible de contener una firma electr&oacute;nica,
