...
//                        System.out.println("----------------------------");
                            ...
                            if (tsToken != null) { // Timestamping Change Openpdf to itext
                                ...
                                System.out.println("TSA:"+tsInfo.getTsa());
                System.out.println("TSA:"+tsInfo.getTsa().getName());
...
//                                    }
    ...
    public static Documento signInfosToCertificados(List<SignInfo> signInfos) throws DocumentoException, CertificadoInvalidoException, IOException, CertificateParsingException {
        Documento documento = null;
        List<Certificado> certificados = new ArrayList<>();
        System.out.println("certificados"+certificados.size());
        if (signInfos == null || signInfos.isEmpty()) {
            return new Documento(false, false, certificados, "Documento sin firmas");
        } else {
            for (SignInfo signInfo : signInfos) {
    ...
    public static Certificado isTimeStamping(SignatureUtil signatureUtil, String signatureName, Certificado certificado) throws CertificateParsingException, SignatureException {
        ...
        System.out.println(pdfPKCS7.getTimeStampToken());
    ...
    public static DatosUsuario infoCertificado(DatosUsuario datosUsuario, SignInfo signInfo) throws CertificateParsingException {
        //extraer información del certificado
        System.out.println("signInfo.getCerts()"+signInfo.getCerts().length);
        X500Principal issuerX500Principal = signInfo.getCerts()[0].getIssuerX500Principal();//CA
        System.out.println(signInfo.getCerts()[0].getSubjectAlternativeNames().toString());
        ...
        System.out.println("subjectX500name"+subjectX500name.toString());
        try {
    ...
    public static Certificado signInfoToCertificado(SignInfo signInfo) throws CertificadoInvalidoException, IOException, CertificateParsingException {
        signInfo.getCerts();
        ...
        Principal subject = signInfo.getCerts()[0].getSubjectDN();
      ...
      for (String s : subjectArray) {
        ...
        System.out.println(key + " - " + value);
                 ...
                 System.out.println("signInfo.getCerts()[0].getSubjectAlternativeNames()"+signInfo.getCerts()[0].getSubjectAlternativeNames());
    System.out.println("signInfo.getCerts()[0]"+signInfo.getCerts()[0].toString());
       // System.out.println("ignInfo.getCerts()[0]"+signInfo.getCerts()[0]);
    ...
    public static boolean verifySignature(X509Certificate certificate, X509Certificate rootCertificate) throws java.security.InvalidKeyException, EntidadCertificadoraNoValidaException {
        ...
        if (rootCertificate != null) {
            ...
            try {
                ...
                System.out.println("certificate verify"+certificate.getSubjectX500Principal());
                return true;
