...
public class C2_01_SignHelloWorld {
    ...
    public static final String DEST = "e://pruebas/";

    public static final String KEYSTORE = "e://pruebas/r.p12";
    public static final String SRC = "e://pruebas/docto.pdf";

    public static final char[] PASSWORD = "YOV23nari".toCharArray();
